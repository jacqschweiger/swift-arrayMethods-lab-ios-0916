 ...
 */
var dayOfTheWeek: [String] = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"]
 ...
 */
dayOfTheWeek.append("Saturday")
dayOfTheWeek.append("Sunday")

for (index, day) in dayOfTheWeek.enumerate() {
    print("\(index+1). \(day)")
}
 ...
 */
dayOfTheWeek.removeAtIndex(6)

print(dayOfTheWeek)

dayOfTheWeek.insert("Sunday", atIndex: 0)
 ...
 */
if dayOfTheWeek.count > 5 {
    dayOfTheWeek.removeAtIndex(6)
    dayOfTheWeek.removeAtIndex(0)
    print(dayOfTheWeek)
}
